...
<c:forEach items="${pageBean.list}" var="user" varStatus="s">
    ...
    <div>
        <nav aria-label="Page navigation">
            <ul class="pagination">
                <li>
                <a href="${pageContext.request.contextPath}/findUserByPageServlet?currentPage=${pageBean.currentPage-1}&rows=3" aria-label="Previous">${i}
               ...
               <c:forEach begin="1" end="${pageBean.totalPage}" var="i">
                ...
                <li>
                <a href="${pageContext.request.contextPath}/findUserByPageServlet?currentPage=${pageBean.currentPage+1}&rows=3&totalPage=${pageBean.totalPage}" aria-label="Next">${i}
                    <span aria-hidden="true">&raquo;</span>
                </a>

                </li>
                <span style="font-size: 25px;margin-left: 5px">一共${pageBean.totalCount}条记录，共${pageBean.totalPage}页</span>
            </ul>
        </nav>
    </div>
</div>
